        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto col-md-6 col-10 bg-white p-5" >
                    ...
                    <form action="/customers/updateCustomer/<?php echo $data['registros']['id']; ?>" method="POST">
                    ...
                    </small> </div> <button type="submit" class="btn btn-dark" name="atualizar">Atualizar</button>
                </form>
                </div>
            </div>
        </div>
